  ...
  LIMIT 50
            ...
            while($chat_obj2 = $chat2->fetch_object()) {
                ...
                <div class="raum <?php echo $farbe2; ?>" data-id="<?php echo $chat_obj2->id; ?>">
                    ...
                    $str = preg_replace_callback('#(?:https?://\S+)|(?:www.\S+)|(?:jpe?g|png|gif)#', function ($arr) {
                        ...
                        // youtube
                        if(in_array($url['host'], array('www.youtube.com', 'youtube.com', 'youtu.be', 'www.youtu.be')) || $url['path'] == '/watch' && isset($url['query'])) {
    ...
    <form method="post" id="chat-posten">
        <textarea placeholder="Schreibe eine Nachricht ..."
                  data-cookie="<?php echo $_COOKIE['username']; ?>"></textarea>
    </form>
</div><!--chat-->