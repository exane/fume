<?php
  ...
  class Model {
    ...
    {
      if(DATABASE) {
        $this->db = new PDO(DRIVER . ':host=' . HOST . ';dbname=' . DB, USER, PW, [PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_OBJ, PDO::ATTR_PERSISTENT => true, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION]);
      }
